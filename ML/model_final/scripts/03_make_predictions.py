...
def make_predictions():
    ...
    try:
        model_arima = joblib.load("../models/arima_model.pkl")
    ...
    new_df.to_csv("../data/predictions/latest_predictions.csv", index=False)
    ...
    plot_predictions(btc_predictions)

def plot_predictions(btc_predictions):
